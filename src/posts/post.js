    ...
    return (
        <div className="text-left">
           ...
           <div className="row p-1">
            ...
            <div className="row p-1">
                <div className="col-sm-2 col-xl-2 p-2">
                    <img src={require("../Assets/pic1.jpg")} className="img-responsive rounded-circle post-pic  p-2"/>
            ...
            <div className="row p-1">
                <div className="col-sm-2 col-xl-2 p-2">
                    <img src={require("../Assets/pic2.jpg")} className="img-responsive rounded-circle post-pic  p-2"/>
            ...
            <div className="row p-1">
                <div className="col-sm-2 col-xl-2 p-2">
                    <img src={require("../Assets/pic3.jpg")} className="img-responsive rounded-circle post-pic  p-2"/>
